...
export default function Post({
  ...
  return (
    <>
      <div
        className={`${varela_round.className} w-full flex flex-col border border-solid border-gray-200 rounded-lg bg-white my-5 transition ease-in-out duration-500 hover:shadow-xl`}
      >
