  ...
  return (
    <>
        <form onSubmit={onSubmitHandler} className='w-full'>
              ...
              <input type='text' defaultValue={lastName} name='lastName' className='w-full border border-gray-200 shadow-inner mb-2 py-1 px-2 rounded-md'/>   
              <label htmlFor='username' className='font-semibold'>Username:</label>
              <input type='text' defaultValue={username} name='username' className='w-full border border-gray-200 shadow-inner mb-2 py-1 px-2 rounded-md'/>   
              <label htmlFor='gender' className='font-semibold'>Gender:</label>
              <input type='text' defaultValue={gender} name='gender' className='w-full border border-gray-200 shadow-inner mb-2 py-1 px-2 rounded-md'/>   
              <label htmlFor='bio' className='font-semibold'>Bio:</label>
              <input type='text' defaultValue={bio} name='bio' className='w-full border border-gray-200 shadow-inner mb-2 py-1 px-2 rounded-md'/>   
